...
// ========================
// SAFE INIT (FAST START)
// ========================
const app = express();

// ========================
// HEALTH CHECK (FIRST THING)
// ========================
...
// ========================
// BASIC MIDDLEWARE (SAFE ORDER)
// ========================
app.use(express.json({ limit: '10mb' }));
app.use(express.urlencoded({ extended: true, limit: '10mb' }));

// ========================
// START SERVER IMMEDIATELY (CRITICAL FIX)
// ========================
...
// ========================
// OPTIONAL: LOAD HEAVY MODULES AFTER START
// ========================
setTimeout(() => {
  try {
